 ...
 */
public class Donor_RegistrationFrame4 extends JFrame {

    Donor_RegistrationFrame4 CurrentFrame = this;
    ...
    Donor_RegistrationFrame4() {
        ...
        ImageIcon background_img = new ImageIcon("C:\\pics\\7.png");
        ...
        bHome.addActionListener(new ListenToButton());
        bQuit.addActionListener(new ListenToButton());
        ...
        bHome.setBounds(650, 620, 100, 50);
        bHome.setFont(new Font("Aerial", Font.BOLD, 15));
        bQuit.setBounds(650, 620, 100, 50);
        bQuit.setFont(new Font("Aerial", Font.BOLD, 15));
            ...
            if (ae.getSource() == bBack) {
                ...
                try {
                    ...
                    if (combo.getSelectedItem().toString().equals("A+") || combo.getSelectedItem().toString().equals("A-") || combo.getSelectedItem().toString().equals("B+") || combo.getSelectedItem().toString().equals("B-") || combo.getSelectedItem().toString().equals("AB+") || combo.getSelectedItem().toString().equals("AB-") || combo.getSelectedItem().toString().equals("O+") || combo.getSelectedItem().toString().equals("O-")) {
                        ...
                        JOptionPane.showMessageDialog(null, "Thank you! your form successfullu submited");
                    } else {
                        JOptionPane.showMessageDialog(null, "SORRY! you did not choose any blood type");
                    }
                    
                    try {
                        String filename = "Donor_Registrationfile.txt";
                        FileWriter fileWriter = new FileWriter(filename,true);
                        fileWriter.append( name + " " + lastName + " " + CNIC + " " + Phone + " " + City + " " + Country + " " + combo.getSelectedItem().toString() + " \n");
                        fileWriter.close();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                      
//                    String Text = ("Name :" + name + " " + lastName + " CNIC : " + CNIC + " Phone number : " + Phone + " City : " + City + " Country :" + Country + " Blood type : " + combo.getSelectedItem().toString() + " \n"));
//                    try {
//                     Files.write(Paths.get("Donor_Registrationfile.txt.txt"), Text.getBytes(), StandardOpenOption.APPEND);
//                       } catch (IOException e) {
...
//                           
                    try {
                        ...
                        String query1 = "insert into donner(name,lastname,cnic,phonenumber,city,country,bloodgroup) values (?,?,?,?,?,?,?)";
    ...
    private class BloodOption implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent ie) {
            if (ie.getStateChange() == ItemEvent.SELECTED) {
                ...
                JOptionPane.showMessageDialog(null, "YOU ARE DOING GREAT JOB ....");
...
private class bSubmit implements ActionListener {

        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(null,"Your form is Succesfully saved" );
